...
$(function(){
	$("#sendCode").click( function () {
		   ...
		   $.post("/RedisDemo_war_exploded/CodeSenderServlet",$("#codeform").serialize(),function(data){
	    	 if(data=="true"){
	    		 t=120;
	    		 clearInterval(interval);
	...
	$("#verifyCode").click( function () {
		   ...
		   $.post("/RedisDemo_war_exploded/CodeVerifyServlet",$("#codeform").serialize(),function(data){
	    	 if(data=="true"){
